...
while ($row = mysqli_fetch_array($result)) {
    ...
    while ($row_product_price = mysqli_fetch_array($result_product)) {
        ...
        $product_price = $row_product_price['price'] * $quantities;
        ...
        $insert_query = "insert into `user_orders` (user_id,amount_due,invoice_number,BiproductID,Quantity,order_date,order_status) values ($users_id, $product_price, $invoice_number,$product_id,$quantities,NOW(),'$status')";
